...
# allows eks worker nodes to connect to amazon eks cluster
...
# provides reas-only access to amazon EC2 container resgitery repo (ECR), usally for core kubernetes related images
